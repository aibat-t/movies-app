...
<template>
  <div class="movie-info-wrap">
    <header class="movie-info-header">
      <h6 class="movie-header-title">Movie List</h6>
...
export default {
  ...
  data: () => ({
    defaultPosterBg:
      "linear-gradient(45deg,rgb(0, 2, 38) 0%,rgb(82, 15, 117) 100%)",
  }),
  methods: {
    closeModal() {
...
.movie-info-header {
  ...
  align-items: center;
  padding: 1rem;
  background: linear-gradient(45deg, rgb(0, 2, 38) 0%, rgb(82, 15, 117) 100%);
  color: #fff;
}
.movie-header-title {
  margin-bottom: 0;
